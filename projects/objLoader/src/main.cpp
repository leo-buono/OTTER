...
int main() {
	...
	ObjLoader blade("blade.obj", true);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform = glm::translate(glm::mat4(1.f), glm::vec3(-1.5f, -1.f, 0.f));
		transform = glm::rotate(transform, angle, glm::vec3(0.f, 1.f, 0.f));

		blade.Draw(camera, transform, rotation, glm::vec3(1.f, 1.f, 1.f), camera->GetPosition(), glm::vec3(3.f));
